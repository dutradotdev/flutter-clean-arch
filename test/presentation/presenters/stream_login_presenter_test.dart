...
import 'package:enquete_dev/domain/helpers/helpers.dart';
...
void main() {
  ...
  test('Should call authentication w/ correct values', () async {
    sut.validateEmail(email);
    sut.validatePassword(password);
  ...
  test('Should emit correct events for loading on Authentication success',
      () async {
    sut.validateEmail(email);
    sut.validatePassword(password);
  ...
  test('Should emit correct events for loading on InvalidCredentialsError',
      () async {
